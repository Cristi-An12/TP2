...
public class Main {
    public static void main (String[] args) {
        ...
        RegistrarInscripto registro = new RegistrarInscripto ();
        ...
        registro.registrar (concurso.nombreDelConcurso (), participante3.numeroDeInscripto ());
        registro.registrar (concurso.nombreDelConcurso (), participante1.numeroDeInscripto () );
        registro.registrar (concurso.nombreDelConcurso (), participante2.numeroDeInscripto () );
        registro.registrar (concurso.nombreDelConcurso (), participante3.numeroDeInscripto () );
